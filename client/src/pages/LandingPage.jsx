          ...
          <div class="relative flex flex-col md:flex-row">
            ...
            >
              <span class="mx-auto text-xl font-black leading-none text-gray-900 select-none">
                DeStockX<span class="text-indigo-600">.</span>
              </span>
            </a>
          ...
          <div class="flex flex-wrap items-center sm:-mx-3">
            <div class="w-full md:w-1/2 md:px-3">
              <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                  <span class="block xl:inline">Transparent Tool to</span>
                  <span class="block text-indigo-600 xl:inline">
                    Help You Invest.
                  </span>
                </h1>
                <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  It's never been easier to invest into companies that convey
            ...
            <div class="w-full md:w-1/2">
              <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                <img src="https://plus.unsplash.com/premium_photo-1663931932687-c4c2366a5c61?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" />
              </div>
            </div>
          </div>
        </div>
